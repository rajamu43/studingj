 ...
 */
 function doctorlist(){
		...
		var data = document.getElementById("listdoctors").value
			/*<![CDATA[*/
		//var data = /*[[${listdoctors}]]*/'a';
		...
		for(var i=0;i<data1.length;i++){
			doctorList.push(data1[i]['registid']);
			console.log(data1[i]['registid']);
		}
	...
	data1.forEach(function(item) {
		...
		function checkboxFormatter(row, cell, value, columnDef, dataContext) {
			let a=dataContext.registid;
			let b=dataContext.doctors;
		...
		function buttonFormatter(row, cell, value, columnDef, dataContext) {
			let a=dataContext.registid;
			let b=dataContext.doctors;
			let c=dataContext.docspecial;
			//return '<input type="checkbox" value="'+a+','+b+'" name="checkName" id="checkBox"' + (value ? 'checked="checked"' : '') + '/>';
			return '<form action="/appointments" method="get" th:object="${checkdid}"><button type="submit" name="patientGender" value="'+a+','+c+','+b+'">Book</button></form>';
	...
	$(function() {
		...
		function filter(item) {
		    ...
		    grid = new Slick.Grid("#docotor", dataView, columns, options);
