...
console.log(check);
	function buttonFormatter(row, cell, value, columnDef, dataContext) {
		...
		let d=dataContext.doctorid;
			...
			return '<form action="/giveappoint" method="post" th:object="${check}"><button type="submit" name="doctorGender" value="'+b+','+d+','+a+'">Apply</button></form>';
			
		}
		function buttonsFormatter(row,cell,Value,coloumnDef,dataContext){
    
    var appStatus= dataContext.status;
    if(appStatus == 'datechange'){
        let a=dataContext.sno;
        return '<form action="/accept" method="post" th:object="${checkdate}"><button class="active" type="submit" name="patientGender" value="'+a+'">Accept</button></form>';
